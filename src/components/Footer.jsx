    ...
    <>
      ...
      >
        <div className="flex flex-col justify-center">
          <h1
            className="text-[10px] text-gray-200
                    md:text-[14px]
                    xl:text-[18px]
                    min-[2000px]:text-[20px]"
          >
            About this page
          </h1>
          <Anchor to="/home">
            <h1
              className="text-[10px] text-gray-200 hover:text-gray-300
                        md:text-[12px]
                        xl:text-[14px]
          ...
          <Anchor to="/cities">
            <h1
              className="text-[10px] text-gray-100 hover:text-gray-300
                        md:text-[12px]
                        xl:text-[14px]
                        min-[2000px]:text-[18px]"
            >
        ...
        <div className="flex flex-col">
          ...
          <ul
            className="list-none text-[10px] text-gray-100 hover:text-gray-300
                    md:text-[12px]
                    xl:text-[14px]
                    min-[2000px]:text-[18px]"
          >
